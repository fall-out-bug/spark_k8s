...
| Spark Operator v2 Migration | 🔧 OPEN | Q0 decided 2026-08-09: **kubeflow** (apache 1.0 dropped Spark 3.5). Standalone chart already kubeflow v2.5.1; per-version image refs in spark-{3.5,4.0,4.1} still deprecated googlecloudplatform — migration pending. |

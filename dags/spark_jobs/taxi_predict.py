...
def generate_forecast(models):
    ...
    for i, forecast_date in enumerate(forecast_dates):
        ...
        X = pd.DataFrame([{
            ...
            'is_rush_hour': 0,
            'is_holiday': 0,
            'trip_distance': 3.5,  # Average trip distance
            'trip_duration': 15.0,  # Average duration in minutes
            'avg_speed': 14.0,  # Average speed mph
            'is_airport': 0,
            'daily_revenue': 5000,  # Placeholder
            'daily_trips': 200,  # Placeholder
            'revenue_ma_7d': 35000,  # Placeholder
            'trips_ma_7d': 1400  # Placeholder
        }])

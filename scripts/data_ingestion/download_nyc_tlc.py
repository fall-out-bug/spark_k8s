...
def main():
    ...
    parser.add_argument("--access-key", default=None, help="MinIO access key (env: S3_ACCESS_KEY)")
    parser.add_argument("--secret-key", default=None, help="MinIO secret key (env: S3_SECRET_KEY)")

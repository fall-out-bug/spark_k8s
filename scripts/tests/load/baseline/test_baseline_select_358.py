"""
Baseline load test: Spark 3.5.8 + SELECT + aggregation.
...
def test_baseline_select_aggregation_358(spark_connect_client):
    """
    ...
    metrics = run_sustained_load(
        ...
        query_name="baseline_select_358",
    )
    ...
    # Print summary
    print(f"\n=== Baseline Load Test Summary (3.5.8) ===")

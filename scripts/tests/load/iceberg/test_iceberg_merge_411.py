"""
Iceberg load test: Spark 4.1.1 + MERGE operations.
...
def test_iceberg_merge_load_411(spark_connect_client):
    """
    ...
    print(f"[iceberg_merge_411] Starting sustained load: {duration_sec}s, {interval_sec}s interval")
    ...
    while datetime.now() < end_time:
        try:
            ...
            print(f"[iceberg_merge_411] Merge failed: {e}")
        finally:

"""
Comparison load test: Spark 3.5.8 vs 4.1.1 - JOIN + filter.
...
def test_version_comparison_join_filter(
    spark_358_client,
    spark_411_client,
):
    """
    Compare Spark 3.5.8 vs 4.1.1 performance for JOIN + filter.
    ...
    metrics_358 = run_sustained_load(
        ...
        query_name="comparison_join_358",
    )
    ...
    metrics_411 = run_sustained_load(
        ...
        duration_sec=duration_sec,
        interval_sec=interval_sec,
        query_name="comparison_join_411",
    )
    ...
    # Print summary
    print(f"\n=== Version Comparison Summary (JOIN + Filter) ===")

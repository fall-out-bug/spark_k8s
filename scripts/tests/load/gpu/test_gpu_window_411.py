"""
GPU load test: Spark 4.1.1 + window functions with RAPIDS.
...
def test_gpu_window_functions_411(spark_connect_client):
    """
    ...
    # Print summary
    print(f"\n=== GPU Load Test Summary (4.1.1 Window) ===")

...
def main():
    parser = argparse.ArgumentParser(description="Validate matrix configuration")
    parser.add_argument("matrix_file", type=Path, help="Path to matrix configuration YAML")

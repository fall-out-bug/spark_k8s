# airflow-gpu-connect-k8s-410

> **Type:** `smoke` | **Estimated Time:** `5 min`

## Description

Smoke test for Airflow + Spark Connect + K8s backend + GPU (Spark 4.1.0)
...
| **Preset** | `charts/spark-4.1/airflow-gpu-connect-k8s-4.1.0.yaml` |
...
```bash
# Run the test
/home/fall_out_bug/work/s7/spark_k8s/scripts/tests/smoke/scenarios/airflow-gpu-connect-k8s-410.sh

# Or with parameters
/home/fall_out_bug/work/s7/spark_k8s/scripts/tests/smoke/scenarios/airflow-gpu-connect-k8s-410.sh --version=4.1.0 --component=airflow
```

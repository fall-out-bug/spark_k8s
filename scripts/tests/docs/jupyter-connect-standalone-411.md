...
Smoke test for Jupyter + Spark Connect + Standalone backend (Spark 4.1.1)
...
```bash
# Run the test
/home/fall_out_bug/work/s7/spark_k8s/scripts/tests/smoke/scenarios/jupyter-connect-standalone-411.sh

# Or with parameters
/home/fall_out_bug/work/s7/spark_k8s/scripts/tests/smoke/scenarios/jupyter-connect-standalone-411.sh --version=4.1.1 --component=jupyter
```

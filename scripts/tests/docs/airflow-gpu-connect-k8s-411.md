# airflow-gpu-connect-k8s-411

> **Type:** `smoke` | **Estimated Time:** `5 min`

## Description

Smoke test for Airflow + Spark Connect + K8s backend + GPU (Spark 4.1.1)
...
```bash
# Run the test
/home/fall_out_bug/work/s7/spark_k8s/scripts/tests/smoke/scenarios/airflow-gpu-connect-k8s-411.sh

# Or with parameters
/home/fall_out_bug/work/s7/spark_k8s/scripts/tests/smoke/scenarios/airflow-gpu-connect-k8s-411.sh --version=4.1.1 --component=airflow
```

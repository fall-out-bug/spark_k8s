#!/bin/bash
# Performance test: Airflow basic (Spark 3.5.8)

# @meta
# name: "airflow-perf-358"
# type: "smoke"
# description: "Performance test for Airflow basic workload (Spark 3.5.8)"
# version: "3.5.8"
# component: "airflow"
# mode: "performance"
# features: []
...
# depends_on: []
# tags: [smoke, airflow, performance, 3.5.8]
# @endmeta
...
APP_NAME="airflow-perf-test-358"
...
setup_test_environment() {
    ...
    # Create release name
    local release_name
    release_name="$(create_release_name "airflow-perf-" "$(generate_short_test_id)")"
...
deploy_spark() {
    log_section "Deploying Airflow for performance testing"
...
print_results() {
    ...
    echo "Configuration: Spark $SPARK_VERSION, Airflow Performance"
    kubectl get pods -n "$TEST_NAMESPACE" -o wide
}

main() {
    log_section "Performance Smoke Test: Airflow (3.5.8)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

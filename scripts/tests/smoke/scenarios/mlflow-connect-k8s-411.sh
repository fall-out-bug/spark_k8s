#!/bin/bash
# Smoke test: MLflow + Connect K8s (Spark 4.1.1)

# @meta
# name: "mlflow-connect-k8s-411"
# type: "smoke"
# description: "Smoke test for MLflow + Spark Connect + K8s backend (Spark 4.1.1)"
# version: "4.1.1"
# component: "mlflow"
# mode: "connect-k8s"
# features: []
...
# depends_on: []
# tags: [smoke, mlflow, connect-k8s, 4.1.1]
# @endmeta
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "mlflow-connect-k8s" "411")
...
main() {
    log_section "Smoke Test: MLflow + Connect + K8s (4.1.1)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

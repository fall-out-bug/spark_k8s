#!/bin/bash
# Load test: Jupyter (Spark 3.5.7)

# @meta
# name: "jupyter-load-357"
# type: "smoke"
# description: "Load test for Jupyter (Spark 3.5.7)"
# version: "3.5.7"
# component: "jupyter"
# mode: "load"
# features: []
...
APP_NAME="jupyter-load-test-357"
...
setup_test_environment() {
    ...
    # Create release name
    local release_name
    release_name="$(create_release_name "jupyter-load-" "$(generate_short_test_id)")"
...
main() {
    log_section "Load Smoke Test: Jupyter (3.5.7)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

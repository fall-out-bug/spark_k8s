#!/bin/bash
# Smoke test: MLflow + Iceberg + K8s (Spark 3.5.8)

# @meta
# name: "mlflow-iceberg-k8s-358"
# type: "smoke"
# description: "Smoke test for MLflow with Iceberg support (Spark 3.5.8)"
# version: "3.5.8"
# component: "mlflow"
# mode: "iceberg-k8s"
# features: ["iceberg"]
...
# depends_on: []
# tags: [smoke, mlflow, iceberg, k8s, 3.5.8]
# @endmeta
...
APP_NAME="mlflow-iceberg-test-358"
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "mlflow-iceberg" "358")
...
main() {
    log_section "Smoke Test: MLflow + Iceberg (3.5.8)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

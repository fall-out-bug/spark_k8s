#!/bin/bash
# Security test: MLflow basic (Spark 3.5.8)

# @meta
# name: "mlflow-sec-358"
# type: "smoke"
# description: "Security test for MLflow (Spark 3.5.8)"
# version: "3.5.8"
# component: "mlflow"
# mode: "security"
# features: []
...
# depends_on: []
# tags: [smoke, mlflow, security, 3.5.8]
# @endmeta
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "mlflow-sec" "358")
...
main() {
    log_section "Security Smoke Test: MLflow (3.5.8)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

#!/bin/bash
# Smoke test: MLflow + Iceberg + K8s (Spark 4.1.1)

# @meta
# name: "mlflow-iceberg-k8s-411"
# type: "smoke"
# description: "Smoke test for MLflow with Iceberg support (Spark 4.1.1)"
# version: "4.1.1"
# component: "mlflow"
# mode: "iceberg-k8s"
# features: ["iceberg"]
...
# depends_on: []
# tags: [smoke, mlflow, iceberg, k8s, 4.1.1]
# @endmeta
...
APP_NAME="mlflow-iceberg-test-411"
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "mlflow-iceberg" "411")
...
main() {
    log_section "Smoke Test: MLflow + Iceberg (4.1.1)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

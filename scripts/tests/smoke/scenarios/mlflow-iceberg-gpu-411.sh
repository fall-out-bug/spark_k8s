#!/bin/bash
# Smoke test: MLflow + Iceberg + GPU (Spark 4.1.1)

# @meta
# name: "mlflow-iceberg-gpu-411"
# type: "smoke"
# description: "Smoke test for MLflow with Iceberg and GPU support (Spark 4.1.1)"
# version: "4.1.1"
# component: "mlflow"
# mode: "iceberg-gpu"
...
# depends_on: []
# tags: [smoke, mlflow, iceberg, gpu, 4.1.1]
# @endmeta
...
APP_NAME="mlflow-iceberg-gpu-test-411"
...
main() {
    log_section "Smoke Test: MLflow + Iceberg + GPU (4.1.1)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

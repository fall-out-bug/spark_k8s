#!/bin/bash
# Smoke test: MLflow + Iceberg + GPU (Spark 4.1.0)

# @meta
# name: "mlflow-iceberg-gpu-410"
# type: "smoke"
# description: "Smoke test for MLflow with Iceberg and GPU support (Spark 4.1.0)"
# version: "4.1.0"
# component: "mlflow"
# mode: "iceberg-gpu"
...
# depends_on: []
# tags: [smoke, mlflow, iceberg, gpu, 4.1.0]
# @endmeta
...
APP_NAME="mlflow-iceberg-gpu-test-410"
...
main() {
    log_section "Smoke Test: MLflow + Iceberg + GPU (4.1.0)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

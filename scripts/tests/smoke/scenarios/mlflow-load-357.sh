#!/bin/bash
# Load test: MLflow (Spark 3.5.7)

# @meta
# name: "mlflow-load-357"
# type: "smoke"
# description: "Load test for MLflow (Spark 3.5.7)"
# version: "3.5.7"
# component: "mlflow"
# mode: "load"
# features: []
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "mlflow-load" "357")
...
main() {
    log_section "Load Smoke Test: MLflow (3.5.7)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

#!/bin/bash
# Smoke test: MLflow + Spark Connect + Standalone backend (Spark 4.1.1)

# @meta
# name: "mlflow-connect-standalone-411"
# type: "smoke"
# description: "Smoke test for MLflow + Spark Connect + Standalone backend (Spark 4.1.1)"
# version: "4.1.1"
# component: "mlflow"
# mode: "connect-standalone"
# features: []
# chart: "charts/spark-4.1"
# preset: "charts/spark-4.1/mlflow-connect-standalone-4.1.1.yaml"
# estimated_time: "5 min"
# depends_on: []
# tags: [smoke, mlflow, connect-standalone, 4.1.1]
# @endmeta
...
PRESET_PATH="${PROJECT_ROOT}/charts/spark-4.1/mlflow-connect-standalone-4.1.1.yaml"
SPARK_VERSION="4.1.1"
IMAGE_TAG="4.1.1"
...
main() {
    log_section "Smoke Test: MLflow + Spark Connect + Standalone (4.1.1)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

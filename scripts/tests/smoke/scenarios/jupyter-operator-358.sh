#!/bin/bash
# Smoke test: Jupyter + Spark Operator (Spark 3.5.8)

# @meta
# name: "jupyter-operator-358"
# type: "smoke"
# description: "Smoke test for Jupyter with Spark Operator (Spark 3.5.8)"
# version: "3.5.8"
# component: "jupyter"
# mode: "operator"
# features: []
...
# depends_on: []
# tags: [smoke, jupyter, operator, 3.5.8]
# @endmeta
...
APP_NAME="jupyter-operator-test-358"
...
setup_test_environment() {
    ...
    # Create release name
    local release_name
    release_name="$(create_release_name "jupyter-operator-" "$(generate_short_test_id)")"
...
main() {
    log_section "Smoke Test: Jupyter + Operator (3.5.8)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

#!/bin/bash
# Performance test: Jupyter basic (Spark 3.5.7)

# @meta
# name: "jupyter-perf-357"
# type: "smoke"
# description: "Performance test for Jupyter basic workload (Spark 3.5.7)"
# version: "3.5.7"
# component: "jupyter"
# mode: "performance"
# features: []
...
# depends_on: []
# tags: [smoke, jupyter, performance, 3.5.7]
# @endmeta
...
APP_NAME="jupyter-perf-test-357"
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "jupyter-perf" "357")
...
main() {
    log_section "Performance Smoke Test: Jupyter (3.5.7)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

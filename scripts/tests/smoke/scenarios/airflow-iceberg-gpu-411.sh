#!/bin/bash
# Smoke test: Airflow + Iceberg + GPU (Spark 4.1.1)

# @meta
# name: "airflow-iceberg-gpu-411"
# type: "smoke"
# description: "Smoke test for Airflow with Iceberg and GPU support (Spark 4.1.1)"
# version: "4.1.1"
# component: "airflow"
# mode: "iceberg-gpu"
...
# depends_on: []
# tags: [smoke, airflow, iceberg, gpu, 4.1.1]
# @endmeta
...
APP_NAME="airflow-iceberg-gpu-test-411"
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "airflow-iceberg-gpu" "411")
...
main() {
    log_section "Smoke Test: Airflow + Iceberg + GPU (4.1.1)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

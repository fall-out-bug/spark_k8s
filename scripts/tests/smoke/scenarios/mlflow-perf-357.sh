#!/bin/bash
# Performance test: MLflow basic (Spark 3.5.7)

# @meta
# name: "mlflow-perf-357"
# type: "smoke"
# description: "Performance test for MLflow basic workload (Spark 3.5.7)"
# version: "3.5.7"
# component: "mlflow"
# mode: "performance"
# features: []
...
# depends_on: []
# tags: [smoke, mlflow, performance, 3.5.7]
# @endmeta
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "mlflow-perf" "357")
...
main() {
    log_section "Performance Smoke Test: MLflow (3.5.7)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

#!/bin/bash
# Smoke test: MLflow + Iceberg + GPU (Spark 3.5.8)

# @meta
# name: "mlflow-iceberg-gpu-358"
# type: "smoke"
# description: "Smoke test for MLflow with Iceberg and GPU support (Spark 3.5.8)"
# version: "3.5.8"
# component: "mlflow"
# mode: "iceberg-gpu"
...
# depends_on: []
# tags: [smoke, mlflow, iceberg, gpu, 3.5.8]
# @endmeta
...
APP_NAME="mlflow-iceberg-gpu-test-358"
...
main() {
    log_section "Smoke Test: MLflow + Iceberg + GPU (3.5.8)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

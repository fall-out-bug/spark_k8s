#!/bin/bash
# Smoke test: MLflow + Spark Operator (Spark 4.1.0)

# @meta
# name: "mlflow-operator-410"
# type: "smoke"
# description: "Smoke test for MLflow with Spark Operator (Spark 4.1.0)"
# version: "4.1.0"
# component: "mlflow"
# mode: "operator"
# features: []
...
# depends_on: []
# tags: [smoke, mlflow, operator, 4.1.0]
# @endmeta
...
APP_NAME="mlflow-operator-test-410"
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "mlflow-operator" "410")
...
main() {
    log_section "Smoke Test: MLflow + Operator (4.1.0)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

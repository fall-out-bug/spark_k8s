#!/bin/bash
# Security test: MLflow basic (Spark 3.5.7)

# @meta
# name: "mlflow-sec-357"
# type: "smoke"
# description: "Security test for MLflow (Spark 3.5.7)"
# version: "3.5.7"
# component: "mlflow"
# mode: "security"
# features: []
...
# depends_on: []
# tags: [smoke, mlflow, security, 3.5.7]
# @endmeta
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "mlflow-sec" "357")
...
main() {
    log_section "Security Smoke Test: MLflow (3.5.7)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

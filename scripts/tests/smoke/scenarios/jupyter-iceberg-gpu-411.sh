#!/bin/bash
# Smoke test: Jupyter + Iceberg + GPU (Spark 4.1.1)

# @meta
# name: "jupyter-iceberg-gpu-411"
# type: "smoke"
# description: "Smoke test for Jupyter with Iceberg and GPU support (Spark 4.1.1)"
# version: "4.1.1"
# component: "jupyter"
# mode: "iceberg-gpu"
...
# depends_on: []
# tags: [smoke, jupyter, iceberg, gpu, 4.1.1]
# @endmeta
...
APP_NAME="jupyter-iceberg-gpu-test-411"
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "jupyter-iceberg-gpu" "411")
...
main() {
    log_section "Smoke Test: Jupyter + Iceberg + GPU (4.1.1)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

#!/bin/bash
# Smoke test: MLflow + GPU (Spark 4.1.1)

# @meta
# name: "mlflow-gpu-411"
# type: "smoke"
# description: "Smoke test for MLflow with GPU support (Spark 4.1.1)"
# version: "4.1.1"
# component: "mlflow"
# mode: "gpu"
# features: ["gpu"]
...
setup_test_environment() {
    ...
    # Create release name
    local release_name
    release_name="$(create_release_name "mlflow-gpu-" "$(generate_short_test_id)")"
...
main() {
    log_section "Smoke Test: MLflow + GPU (4.1.1)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

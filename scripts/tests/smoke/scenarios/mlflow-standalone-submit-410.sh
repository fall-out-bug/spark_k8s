#!/bin/bash
# Smoke test: MLflow + Spark Standalone-submit mode (Spark 4.1.0)

# @meta
# name: "mlflow-standalone-submit-410"
# type: "smoke"
# description: "Smoke test for MLflow + Spark Standalone-submit mode (Spark 4.1.0)"
# version: "4.1.0"
# component: "mlflow"
# mode: "standalone-submit"
# features: []
# chart: "charts/spark-4.1"
# preset: "charts/spark-4.1/mlflow-standalone-submit-4.1.0.yaml"
# estimated_time: "5 min"
# depends_on: []
# tags: [smoke, mlflow, standalone-submit, 4.1.0]
# @endmeta
...
PRESET_PATH="${PROJECT_ROOT}/charts/spark-4.1/mlflow-standalone-submit-4.1.0.yaml"
SPARK_VERSION="4.1.0"
IMAGE_TAG="4.1.0"
...
setup_test_environment() {
    ...
    # Create release name
    local release_name
    release_name="$(create_release_name "mlflow-standalone-submit-" "$(generate_short_test_id)")"
...
main() {
    log_section "Smoke Test: MLflow + Standalone-submit (4.1.0)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

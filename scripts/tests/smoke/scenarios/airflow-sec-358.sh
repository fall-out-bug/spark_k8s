#!/bin/bash
# Security test: Airflow basic (Spark 3.5.8)

# @meta
# name: "airflow-sec-358"
# type: "smoke"
# description: "Security test for Airflow (Spark 3.5.8)"
# version: "3.5.8"
# component: "airflow"
# mode: "security"
# features: []
...
# depends_on: []
# tags: [smoke, airflow, security, 3.5.8]
# @endmeta
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "airflow-sec" "358")
...
main() {
    log_section "Security Smoke Test: Airflow (3.5.8)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

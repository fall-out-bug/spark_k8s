#!/bin/bash
# Smoke test: Airflow + Spark Operator (Spark 3.5.8)

# @meta
# name: "airflow-operator-358"
# type: "smoke"
# description: "Smoke test for Airflow with Spark Operator (Spark 3.5.8)"
# version: "3.5.8"
# component: "airflow"
# mode: "operator"
# features: []
...
# depends_on: []
# tags: [smoke, airflow, operator, 3.5.8]
# @endmeta
...
APP_NAME="airflow-operator-test-358"
...
setup_test_environment() {
    ...
    # Create release name
    local release_name
    release_name="$(create_release_name "airflow-operator-" "$(generate_short_test_id)")"
...
main() {
    log_section "Smoke Test: Airflow + Operator (3.5.8)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

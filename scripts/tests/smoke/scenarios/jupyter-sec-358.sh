#!/bin/bash
# Security test: Jupyter basic (Spark 3.5.8)

# @meta
# name: "jupyter-sec-358"
# type: "smoke"
# description: "Security test for Jupyter (Spark 3.5.8)"
# version: "3.5.8"
# component: "jupyter"
# mode: "security"
# features: []
...
# depends_on: []
# tags: [smoke, jupyter, security, 3.5.8]
# @endmeta
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "jupyter-sec" "358")
...
main() {
    log_section "Security Smoke Test: Jupyter (3.5.8)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

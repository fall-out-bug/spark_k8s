#!/bin/bash
# Smoke test: Airflow + Spark Standalone-submit mode (Spark 4.1.0)

# @meta
# name: "airflow-standalone-submit-410"
# type: "smoke"
# description: "Smoke test for Airflow + Spark Standalone-submit mode (Spark 4.1.0)"
# version: "4.1.0"
# component: "airflow"
# mode: "standalone-submit"
# features: []
# chart: "charts/spark-4.1"
# preset: "charts/spark-4.1/airflow-standalone-submit-4.1.0.yaml"
# estimated_time: "5 min"
# depends_on: []
# tags: [smoke, airflow, standalone-submit, 4.1.0]
# @endmeta
...
PRESET_PATH="${PROJECT_ROOT}/charts/spark-4.1/airflow-standalone-submit-4.1.0.yaml"
SPARK_VERSION="4.1.0"
IMAGE_TAG="4.1.0"
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "airflow-standalone-submit" "410")
...
main() {
    log_section "Smoke Test: Airflow + Standalone-submit (4.1.0)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

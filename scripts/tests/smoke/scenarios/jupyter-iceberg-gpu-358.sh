#!/bin/bash
# Smoke test: Jupyter + Iceberg + GPU (Spark 3.5.8)

# @meta
# name: "jupyter-iceberg-gpu-358"
# type: "smoke"
# description: "Smoke test for Jupyter with Iceberg and GPU support (Spark 3.5.8)"
# version: "3.5.8"
# component: "jupyter"
# mode: "iceberg-gpu"
...
# depends_on: []
# tags: [smoke, jupyter, iceberg, gpu, 3.5.8]
# @endmeta
...
APP_NAME="jupyter-iceberg-gpu-test-358"
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "jupyter-iceberg-gpu" "358")
...
main() {
    log_section "Smoke Test: Jupyter + Iceberg + GPU (3.5.8)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

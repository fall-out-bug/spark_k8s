#!/bin/bash
# Security test: Jupyter basic (Spark 4.1.1)

# @meta
# name: "jupyter-sec-411"
# type: "smoke"
# description: "Security test for Jupyter (Spark 4.1.1)"
# version: "4.1.1"
# component: "jupyter"
# mode: "security"
# features: []
...
# depends_on: []
# tags: [smoke, jupyter, security, 4.1.1]
# @endmeta
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "jupyter-sec" "411")
...
main() {
    log_section "Security Smoke Test: Jupyter (4.1.1)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

#!/bin/bash
# Performance test: MLflow basic (Spark 4.1.0)

# @meta
# name: "mlflow-perf-410"
# type: "smoke"
# description: "Performance test for MLflow basic workload (Spark 4.1.0)"
# version: "4.1.0"
# component: "mlflow"
# mode: "performance"
# features: []
...
# depends_on: []
# tags: [smoke, mlflow, performance, 4.1.0]
# @endmeta
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "mlflow-perf" "410")
...
main() {
    log_section "Performance Smoke Test: MLflow (4.1.0)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

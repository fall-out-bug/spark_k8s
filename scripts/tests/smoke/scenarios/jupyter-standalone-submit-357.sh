#!/bin/bash
# Smoke test: Jupyter + Spark Standalone-submit mode (Spark 3.5.7)

# @meta
# name: "jupyter-standalone-submit-357"
# type: "smoke"
# description: "Smoke test for Jupyter + Spark Standalone-submit mode (Spark 3.5.7)"
# version: "3.5.7"
# component: "jupyter"
# mode: "standalone-submit"
# features: []
# chart: "charts/spark-3.5"
# preset: "charts/spark-3.5/jupyter-standalone-submit-3.5.7.yaml"
# estimated_time: "5 min"
# depends_on: []
# tags: [smoke, jupyter, standalone-submit, 3.5.7]
# @endmeta
...
PRESET_PATH="${PROJECT_ROOT}/charts/spark-3.5/jupyter-standalone-submit-3.5.7.yaml"
SPARK_VERSION="3.5.7"
IMAGE_TAG="3.5.7"
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "jupyter-standalone-submit" "357")
...
main() {
    log_section "Smoke Test: Jupyter + Standalone-submit (3.5.7)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

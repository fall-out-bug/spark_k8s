#!/bin/bash
# Smoke test: MLflow + Spark Standalone-submit mode (Spark 3.5.7)

# @meta
# name: "mlflow-standalone-submit-357"
# type: "smoke"
# description: "Smoke test for MLflow + Spark Standalone-submit mode (Spark 3.5.7)"
# version: "3.5.7"
# component: "mlflow"
# mode: "standalone-submit"
# features: []
# chart: "charts/spark-3.5"
# preset: "charts/spark-3.5/mlflow-standalone-submit-3.5.7.yaml"
# estimated_time: "5 min"
# depends_on: []
# tags: [smoke, mlflow, standalone-submit, 3.5.7]
# @endmeta
...
PRESET_PATH="${PROJECT_ROOT}/charts/spark-3.5/mlflow-standalone-submit-3.5.7.yaml"
SPARK_VERSION="3.5.7"
IMAGE_TAG="3.5.7"
...
main() {
    log_section "Smoke Test: MLflow + Standalone-submit (3.5.7)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

#!/bin/bash
# Smoke test: Jupyter + Spark Connect + Standalone backend (Spark 3.5.7)

# @meta
# name: "jupyter-connect-standalone-357"
# type: "smoke"
# description: "Smoke test for Jupyter + Spark Connect + Standalone backend (Spark 3.5.7)"
# version: "3.5.7"
# component: "jupyter"
# mode: "connect-standalone"
# features: []
# chart: "charts/spark-3.5"
# preset: "charts/spark-3.5/jupyter-connect-standalone-3.5.7.yaml"
# estimated_time: "5 min"
# depends_on: []
# tags: [smoke, jupyter, connect-standalone, 3.5.7]
# @endmeta
...
PRESET_PATH="${PROJECT_ROOT}/charts/spark-3.5/jupyter-connect-standalone-3.5.7.yaml"
SPARK_VERSION="3.5.7"
IMAGE_TAG="3.5.7"
...
main() {
    log_section "Smoke Test: Jupyter + Spark Connect + Standalone (3.5.7)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

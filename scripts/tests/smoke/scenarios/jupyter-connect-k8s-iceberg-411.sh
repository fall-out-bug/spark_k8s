#!/bin/bash
# Smoke test: Jupyter + Spark Connect + K8s backend + Iceberg (Spark 4.1.1)

# @meta
# name: "jupyter-connect-k8s-iceberg-411"
# type: "smoke"
# description: "Smoke test for Jupyter + Spark Connect + K8s backend + Iceberg (Spark 4.1.1)"
# version: "4.1.1"
# component: "jupyter"
# mode: "connect-k8s"
# features: ["iceberg"]
...
# depends_on: []
# tags: [smoke, jupyter, connect-k8s, iceberg, 4.1.1]
# @endmeta
...
PRESET_PATH="${PROJECT_ROOT}/charts/spark-4.1/jupyter-connect-k8s-iceberg-4.1.1.yaml"
SPARK_VERSION="4.1.1"
IMAGE_TAG="4.1.0"
...
setup_test_environment() {
    ...
    local ns_name="${NAMESPACE_PREFIX}-iceberg-411"
...
main() {
    log_section "Smoke Test: Jupyter + Spark Connect + Iceberg (4.1.1)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

#!/bin/bash
# Smoke test: Airflow + Spark Connect + K8s backend (Spark 3.5.7)

# @meta
# name: "airflow-connect-k8s-357"
# type: "smoke"
# description: "Smoke test for Airflow + Spark Connect + K8s backend (Spark 3.5.7)"
# version: "3.5.7"
# component: "airflow"
# mode: "connect-k8s"
# features: []
# chart: "charts/spark-3.5"
# preset: "charts/spark-3.5/airflow-connect-k8s-3.5.7.yaml"
# estimated_time: "5 min"
# depends_on: []
# tags: [smoke, airflow, connect-k8s, 3.5.7]
# @endmeta
...
PRESET_PATH="${PROJECT_ROOT}/charts/spark-3.5/airflow-connect-k8s-3.5.7.yaml"
SPARK_VERSION="3.5.7"
IMAGE_TAG="3.5.7"
...
deploy_spark() {
    log_section "Deploying Spark Connect (K8s backend mode)"
...
main() {
    log_section "Smoke Test: Airflow + Spark Connect + K8s (3.5.7)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

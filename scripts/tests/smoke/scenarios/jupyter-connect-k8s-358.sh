#!/bin/bash
# Smoke test: Jupyter + Spark Connect + K8s backend (Spark 3.5.8)

# @meta
# name: "jupyter-connect-k8s-358"
# type: "smoke"
# description: "Smoke test for Jupyter + Spark Connect + K8s backend (Spark 3.5.8)"
# version: "3.5.8"
# component: "jupyter"
# mode: "connect-k8s"
# features: []
# chart: "charts/spark-3.5"
# preset: "charts/spark-3.5/jupyter-connect-k8s-3.5.8.yaml"
# estimated_time: "5 min"
# depends_on: []
# tags: [smoke, jupyter, connect-k8s, 3.5.8]
# @endmeta
...
main() {
    log_section "Smoke Test: Jupyter + Spark Connect + K8s (3.5.8)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

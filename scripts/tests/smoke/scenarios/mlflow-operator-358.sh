#!/bin/bash
# Smoke test: MLflow + Spark Operator (Spark 3.5.8)

# @meta
# name: "mlflow-operator-358"
# type: "smoke"
# description: "Smoke test for MLflow with Spark Operator (Spark 3.5.8)"
# version: "3.5.8"
# component: "mlflow"
# mode: "operator"
# features: []
...
# depends_on: []
# tags: [smoke, mlflow, operator, 3.5.8]
# @endmeta
...
APP_NAME="mlflow-operator-test-358"
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "mlflow-operator" "358")
...
main() {
    log_section "Smoke Test: MLflow + Operator (3.5.8)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

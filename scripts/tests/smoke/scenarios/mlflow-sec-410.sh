#!/bin/bash
# Security test: MLflow basic (Spark 4.1.0)

# @meta
# name: "mlflow-sec-410"
# type: "smoke"
# description: "Security test for MLflow (Spark 4.1.0)"
# version: "4.1.0"
# component: "mlflow"
# mode: "security"
# features: []
...
# depends_on: []
# tags: [smoke, mlflow, security, 4.1.0]
# @endmeta
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "mlflow-sec" "410")
...
main() {
    log_section "Security Smoke Test: MLflow (4.1.0)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

#!/bin/bash
# Load test: MLflow (Spark 3.5.8)

# @meta
# name: "mlflow-load-358"
# type: "smoke"
# description: "Load test for MLflow (Spark 3.5.8)"
# version: "3.5.8"
# component: "mlflow"
# mode: "load"
# features: []
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "mlflow-load" "358")
...
main() {
    log_section "Load Smoke Test: MLflow (3.5.8)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

#!/bin/bash
# Smoke test: Airflow + Spark Connect + K8s backend + GPU (Spark 4.1.0)

# @meta
# name: "airflow-gpu-connect-k8s-410"
# type: "smoke"
# description: "Smoke test for Airflow + Spark Connect + K8s backend + GPU (Spark 4.1.0)"
# version: "4.1.0"
# component: "airflow"
# mode: "connect-k8s"
# features: ["gpu"]
...
# depends_on: []
# tags: [smoke, airflow, connect-k8s, gpu, 4.1.0]
# @endmeta
...
PRESET_PATH="${PROJECT_ROOT}/charts/spark-4.1/airflow-gpu-connect-k8s-4.1.0.yaml"
SPARK_VERSION="4.1.0"
IMAGE_TAG="4.1.0-gpu"
...
main() {
    log_section "Smoke Test: Airflow + Spark Connect + GPU (4.1.0)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

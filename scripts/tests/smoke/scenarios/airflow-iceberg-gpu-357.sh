#!/bin/bash
# Smoke test: Airflow + Iceberg + GPU (Spark 3.5.7)

# @meta
# name: "airflow-iceberg-gpu-357"
# type: "smoke"
# description: "Smoke test for Airflow with Iceberg and GPU support (Spark 3.5.7)"
# version: "3.5.7"
# component: "airflow"
# mode: "iceberg-gpu"
...
# depends_on: []
# tags: [smoke, airflow, iceberg, gpu, 3.5.7]
# @endmeta
...
APP_NAME="airflow-iceberg-gpu-test-357"
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "airflow-iceberg-gpu" "357")
...
main() {
    log_section "Smoke Test: Airflow + Iceberg + GPU (3.5.7)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

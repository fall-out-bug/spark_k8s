#!/bin/bash
# Smoke test: Airflow + Spark Connect + K8s backend (Spark 4.1.1)

# @meta
# name: "airflow-connect-k8s-411"
# type: "smoke"
# description: "Smoke test for Airflow + Spark Connect + K8s backend (Spark 4.1.1)"
# version: "4.1.1"
# component: "airflow"
# mode: "connect-k8s"
# features: []
# chart: "charts/spark-4.1"
# preset: "charts/spark-4.1/airflow-connect-k8s-4.1.1.yaml"
# estimated_time: "5 min"
# depends_on: []
# tags: [smoke, airflow, connect-k8s, 4.1.1]
# @endmeta
...
PRESET_PATH="${PROJECT_ROOT}/charts/spark-4.1/airflow-connect-k8s-4.1.1.yaml"
SPARK_VERSION="4.1.1"
IMAGE_TAG="4.1.1"
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "airflow-connect-k8s" "411")
...
main() {
    log_section "Smoke Test: Airflow + Spark Connect + K8s (4.1.1)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

#!/bin/bash
# Smoke test: Airflow + Spark Standalone-submit mode (Spark 3.5.8)

# @meta
# name: "airflow-standalone-submit-358"
# type: "smoke"
# description: "Smoke test for Airflow + Spark Standalone-submit mode (Spark 3.5.8)"
# version: "3.5.8"
# component: "airflow"
# mode: "standalone-submit"
# features: []
# chart: "charts/spark-3.5"
# preset: "charts/spark-3.5/airflow-standalone-submit-3.5.8.yaml"
# estimated_time: "5 min"
# depends_on: []
# tags: [smoke, airflow, standalone-submit, 3.5.8]
# @endmeta
...
PRESET_PATH="${PROJECT_ROOT}/charts/spark-3.5/airflow-standalone-submit-3.5.8.yaml"
SPARK_VERSION="3.5.8"
IMAGE_TAG="3.5.8"
...
setup_test_environment() {
    ...
    local env_setup
    env_setup=$(setup_test_environment "airflow-standalone-submit" "358")
...
main() {
    log_section "Smoke Test: Airflow + Standalone-submit (3.5.8)"
    setup_test_environment
    deploy_spark
    validate_deployment
    run_smoke_test

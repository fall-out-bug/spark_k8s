"""
Jupyter Standalone E2E tests for Spark 3.5.8.

Tests validate Spark 3.5.8 execution via Jupyter with standalone-submit mode.
...
class TestJupyterStandalone358:
    """E2E tests for Jupyter with Spark 3.5.8 in standalone-submit mode."""
...
class TestJupyterStandalone358FullDataset:

...
class TestJupyterK8s357FullDataset:
    ...
    def test_full_dataset_q1_count(self, spark_session, dataset_path, query_metrics):
    ...
    def test_full_dataset_q2_aggregation(self, spark_session, dataset_path, query_metrics):

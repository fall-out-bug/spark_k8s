"""
Airflow GPU E2E tests for Spark 4.1.0.

Tests validate Spark 4.1.0 execution via Airflow with GPU acceleration (RAPIDS).
...
class TestAirflowGPU410:
    """E2E tests for Airflow with GPU acceleration on Spark 4.1.0."""
...
class TestAirflowGPU410FullDataset:

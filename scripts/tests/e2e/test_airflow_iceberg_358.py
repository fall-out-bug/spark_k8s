"""
Airflow Iceberg E2E tests for Spark 3.5.8.

Tests validate Apache Iceberg table operations via Airflow with Spark 3.5.8.
"""
import pytest
...
class TestAirflowIceberg358:
    """E2E tests for Airflow with Iceberg on Spark 3.5.8."""

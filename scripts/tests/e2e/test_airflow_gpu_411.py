"""
Airflow GPU E2E tests for Spark 4.1.1.

Tests validate Spark 4.1.1 execution via Airflow with GPU acceleration (RAPIDS).
...
class TestAirflowGPU411:
    """E2E tests for Airflow with GPU acceleration on Spark 4.1.1."""
...
class TestAirflowGPU411FullDataset:

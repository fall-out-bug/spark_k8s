...
RELEASE_NS="${RELEASE_NS:-pss-restricted-35-test}"
RELEASE_NAME="${RELEASE_NAME:-spark-35-pss-test}"
...
setup_test_environment() {
    ...
    # Create namespace (will be recreated with PSS labels by helm)
...
main() {
    echo "=== PSS Restricted Test for Spark 3.5 ==="

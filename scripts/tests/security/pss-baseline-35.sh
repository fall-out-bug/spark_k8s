#!/bin/bash
# @meta
# name: "pss-baseline-35"
# type: "security"
# description: "PSS baseline compliance for Spark 3.5"
# category: "pss"
# profile: "baseline"
# spark_version: "3.5"
...
RELEASE_NS="${RELEASE_NS:-pss-baseline-35-test}"
RELEASE_NAME="${RELEASE_NAME:-spark-35-baseline-test}"
...
deploy_spark() {
    echo "Deploying Spark 3.5 with PSS baseline..."
...
main() {
    echo "=== PSS Baseline Test for Spark 3.5 ==="

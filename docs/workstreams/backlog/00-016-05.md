...
**Acceptance Criteria:**
- [ ] AC1: AlertManager Helm chart создан
- [ ] AC2: Critical alerts настроены (pod crash, OOM)
- [ ] AC3: Warning alerts настроены (high GC, slow queries)
- [ ] AC4: Slack notification работает
- [ ] AC5: Alert silence/rotation работает

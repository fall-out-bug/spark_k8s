...
**Acceptance Criteria:**
- [ ] AC1: Loki Helm chart создан
- [ ] AC2: Promtail collects logs from all pods
- [ ] AC3: JSON structured logging работает
- [ ] AC4: Trace ID correlation работает
- [ ] AC5: Log sampling настроен
- [ ] AC6: Grafana datasource настроен

...
- [x] AC1: scripts/tests/data/generate-dataset.sh created — ✅
- [x] AC2: NYC Taxi sample Parquet — ✅
- [x] AC3: --size flag (small/medium/large) — ✅
- [x] AC4: nyc-taxi-sample.parquet output — ✅
- [x] AC5: DATASET_PATH variable / integration — ✅

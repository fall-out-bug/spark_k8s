...
- Spark 3.5 + PSS restricted × presets (core-baseline, core-gpu, core-iceberg)
- Spark 4.1 + PSS restricted × presets (core-baseline, core-gpu, core-iceberg)
- Spark 3.5 + PSS baseline × standalone preset
- Spark 4.1 + PSS baseline × standalone preset

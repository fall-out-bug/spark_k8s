...
|---|----------|-------|-----|--------|
| 1 | ~~HIGH~~ | ~~smoke aggregate pipeline~~ | Wire aggregate | ✅ FIXED (aggregate-results uses aggregate_json/junit/html) |
| 2 | MEDIUM | scheduled-tests.yml (daily full run) missing | Create per phase spec | Open |

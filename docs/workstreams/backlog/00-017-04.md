...
- 8 load test сценариев для Go клиента
- Sustained load (30 min)
- Concurrent connections
- Memory/CPU profiling
- Comparison с Python client performance

**Acceptance Criteria:**
- [ ] AC1: 8 load test сценариев созданы
- [ ] AC2: Sustained load 30 min работает
- [ ] AC3: Concurrent connections работают
- [ ] AC4: Query throughput измеряется
- [ ] AC5: Memory/CPU profiling работает
...
- [ ] AC1–AC6: 8 load scenarios — ❌ Not implemented

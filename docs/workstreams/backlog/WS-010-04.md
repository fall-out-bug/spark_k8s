...
**Acceptance Criteria:**
- [ ] AC1: docker/docker-intermediate/jars-rapids/Dockerfile updated
- [ ] AC2: docker/docker-intermediate/jars-iceberg/Dockerfile updated
- [ ] AC3: Build script supports Scala 2.12 (Spark 3.5.x)
- [ ] AC4: Build script supports Scala 2.13 (Spark 4.1.x)
- [ ] AC5: RAPIDS plugin JARs downloaded correctly
- [ ] AC6: Iceberg JARs downloaded correctly
- [ ] AC7: Tests validate JAR availability

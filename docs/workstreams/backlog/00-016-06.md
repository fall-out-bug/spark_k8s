...
**Acceptance Criteria:**
- [ ] AC1: Spark History Server показывает Prometheus metrics
- [ ] AC2: Spark UI link to Jaeger traces
- [ ] AC3: Metrics embedded в Spark UI
- [ ] AC4: Logs embedded в Spark UI
- [ ] AC5: Unified observability view работает
- [ ] AC6: Testing scenarios созданы
...
- [ ] AC1–AC6: Spark UI integration — ⚠️ observability section in spark values; no dedicated templates

**Goal Achieved:** ⚠️ Partial (planned in values; templates TBD)

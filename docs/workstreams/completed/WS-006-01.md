...
- [x] AC1: core/ directory exists for 3.5 and 4.1 — ✅
- [x] AC2: _helpers.tpl with core helpers — ✅
- [x] AC3: values.yaml core: section — ✅
- [x] AC4: helm template --validate passes — ✅
...
| helm template | pass | 16/16 presets | ✅ |
| TODO/FIXME | 0 | 0 | ✅ |
| File Size | <200 LOC | _helpers.tpl ~101 | ✅ |

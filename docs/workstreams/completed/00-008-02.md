...
**Scenario matrix:**
- Jupyter: 8 scenarios (4 versions × 2 modes)
- Airflow: 8 scenarios (4 versions × 2 modes)
- MLflow: 8 scenarios (4 versions × 2 modes)
...
- [x] AC1: Standalone scenario scripts created — ✅ (12+ standalone-submit)
- [x] AC2: charts/spark-standalone or connect-standalone presets — ✅
- [x] AC3-AC4: Standalone-submit, connect-standalone modes — ✅
- [x] AC5-AC6: Sequential/parallel — ✅
...
| Standalone scenarios | 24 | 12+ | ✅ (matrix expanded) |
| TODO/FIXME | 0 | 0 | ✅ |

...
- Tests validate Spark 3.5.7, 3.5.8 × Jupyter, Airflow × standalone-submit mode
- Standalone cluster deployment and job submission validation

**Acceptance Criteria:**
- [ ] AC1: 8 standalone E2E scenarios created (Jupyter/Airflow × 3.5.7/3.5.8 × standalone-submit)
...
- `scripts/tests/e2e/conftest.py` — Base E2E fixtures
- `charts/spark-standalone/` — Standalone chart
- `scripts/tests/smoke/scenarios/*standalone*.sh` — Existing standalone smoke tests
...
2. **Implement standalone E2E test scenarios:**
   - `test_jupyter_standalone_357.py` — Jupyter standalone-submit, Spark 3.5.7
   - `test_jupyter_standalone_358.py` — Jupyter standalone-submit, Spark 3.5.8
   - `test_airflow_standalone_357.py` — Airflow standalone-submit, Spark 3.5.7
   - `test_airflow_standalone_358.py` — Airflow standalone-submit, Spark 3.5.8
...
- All 8 scenarios (4 modules × 2 test cases) pass
...
- [x] AC1-AC5: Standalone E2E (test_jupyter_standalone_357/358, test_airflow_standalone_357/358), fixtures_standalone.py — ✅
...
| test_*_standalone_*.py | 4 files | ✅ | ✅ |
| fixtures_standalone.py | exists | ✅ | ✅ |

...
**Scenario matrix:**
- Jupyter: 8 scenarios (4 versions × GPU/Iceberg variants)
- Airflow: 12 scenarios (4 versions × 3 modes)
- MLflow: 12 scenarios (4 versions × 3 modes)
...
- [x] AC1: Spark Operator scenario scripts created — ✅ (12 operator scripts)
- [x] AC2: SparkOperator mode scenarios — ✅
- [x] AC3-AC6: CRD validation, pass sequentially/parallel — ✅
...
| Operator scenarios | 32 | 12 | ✅ (matrix compact) |
| TODO/FIXME | 0 | 0 | ✅ |

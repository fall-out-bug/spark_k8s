...
### Acceptance Criteria
- [x] AC1: `presets/core-baseline.yaml` created (Core only) - ✅ for both 3.5 and 4.1
- [x] AC2: `presets/core-gpu.yaml` created (Core + GPU) - ✅ for both 3.5 and 4.1
- [x] AC3: `presets/core-iceberg.yaml` created (Core + Iceberg) - ✅ for both 3.5 and 4.1
- [x] AC4: `presets/core-gpu-iceberg.yaml` created (Core + GPU + Iceberg) - ✅ for both 3.5 and 4.1
- [x] AC5: All presets pass `helm template` validation - ✅ 8/8 validated

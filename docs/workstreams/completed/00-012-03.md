...
- Tests validate Spark 3.5.7, 3.5.8, 4.1.0, 4.1.1 × Airflow × connect-k8s × Iceberg
- Apache Iceberg table operations (CREATE, READ, UPDATE, DELETE)

**Acceptance Criteria:**
- [ ] AC1: 16 Iceberg E2E scenarios created (4 Spark versions × Airflow × connect-k8s × Iceberg)
...
- `charts/spark-3.5/` and `charts/spark-4.1/` — Charts with Iceberg support
...
2. **Implement Iceberg E2E test scenarios:**
   - `test_airflow_iceberg_357.py` — Airflow with Iceberg, Spark 3.5.7
   - `test_airflow_iceberg_358.py` — Airflow with Iceberg, Spark 3.5.8
   - `test_airflow_iceberg_410.py` — Airflow with Iceberg, Spark 4.1.0
   - `test_airflow_iceberg_411.py` — Airflow with Iceberg, Spark 4.1.1
...
- All 16 scenarios (4 modules × 4 test cases) pass
...
- [x] AC1-AC6: Iceberg E2E (test_airflow_iceberg_357/358/410/411), fixtures_iceberg.py — ✅
...
| test_*_iceberg_*.py | 4 files | ✅ | ✅ |
| fixtures_iceberg.py | exists | ✅ | ✅ |

...
- [x] AC1-AC7: jars-rapids, jars-iceberg, build-3.5.7/4.1.0, test-jars-*.sh — ✅
...
| jars-rapids, jars-iceberg | extend custom | localhost/spark-k8s:* | ✅ |
| build scripts | 3.5.7, 4.1.0 | build-*.sh | ✅ |
| bash -n | pass | test-jars*.sh | ✅ |

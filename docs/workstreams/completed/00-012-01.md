...
- Tests validate Spark 3.5.7, 3.5.8 × Jupyter, Airflow × k8s-submit, connect-k8s modes
- Standard SQL query set (Q1-Q4) execution and metrics collection

**Acceptance Criteria:**
- [ ] AC1: 24 E2E test scenarios created (Jupyter k8s-submit/connect-k8s, Airflow k8s-submit/connect-k8s × 3.5.7/3.5.8)
...
- `scripts/tests/smoke/scenarios/` — Existing smoke test patterns
- `scripts/tests/data/generate-dataset.sh` — Dataset generation
- `docs/phases/phase-06-e2e.md` — Full specification
...
4. **Implement Core E2E test scenarios:**
   - `test_jupyter_k8s_357.py` — Jupyter k8s-submit mode with Spark 3.5.7
   - `test_jupyter_k8s_358.py` — Jupyter k8s-submit mode with Spark 3.5.8
   - `test_jupyter_connect_k8s_357.py` — Jupyter connect-k8s mode with Spark 3.5.7
   - `test_jupyter_connect_k8s_358.py` — Jupyter connect-k8s mode with Spark 3.5.8
   - `test_airflow_k8s_357.py` — Airflow k8s-submit mode with Spark 3.5.7
   - `test_airflow_k8s_358.py` — Airflow k8s-submit mode with Spark 3.5.8
   - `test_airflow_connect_k8s_357.py` — Airflow connect-k8s mode with Spark 3.5.7
   - `test_airflow_connect_k8s_358.py` — Airflow connect-k8s mode with Spark 3.5.8
...
- All 24 scenarios (8 modules × 3 queries) pass within 1200s timeout
...
### Goal Status
- [x] AC1: 24 E2E test scenarios created — ✅
- [x] AC2: NYC Taxi full dataset integrated — ✅ (with sample fallback)
- [x] AC3: 4 standard SQL queries implemented — ✅
- [x] AC4: Metrics collected — ✅
- [x] AC5: All scenarios complete with timeout < 1200s — ✅
- [x] AC6: Pytest framework with conftest.py fixtures — ✅
...
- **Files Created:** 18
- **Lines Added:** ~1350
- **Test Scenarios:** 32 (8 modules × 4 queries)

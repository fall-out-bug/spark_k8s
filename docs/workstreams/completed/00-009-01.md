...
- `docker/docker-base/jdk-17/Dockerfile` — JDK 17 base Dockerfile (55 LOC)
- `docker/docker-base/jdk-17/test.sh` — unit test script (171 LOC)
...
- ✅ Used JRE (not full JDK) to minimize size
- ✅ No unnecessary packages
- ✅ Image size 65MB (under 200MB)
- ✅ Alpine Linux variant for minimal size
...
### Test Results
```
✅ Java version is 17: openjdk version "17.0.17" 2025-10-21
✅ JAVA_HOME is set: /opt/java/openjdk
✅ bash is available: GNU bash, version 5.2.37
✅ curl is available: curl 8.14.1
✅ CA certificates are present
✅ Java can execute with memory constraints
✅ Running as non-root user: spark (UID: 1000)
✅ Work directory /workspace exists
✅ Image size is 65MB (under 200MB limit)
```
...
- [x] AC1-AC6: Dockerfile, build, size &lt;200MB, test.sh, Java 17, utilities — ✅

...
- 8 security smoke тестов созданы (4 PSS + 4 SCC)
- scripts/tests/lib/security-validation.sh библиотека создана
- Все тесты следуют существующему pattern с YAML frontmatter
- Тесты валидируют PSS compliance и SCC assignment

**Acceptance Criteria:**
- [ ] AC1: scripts/tests/security/pss-restricted-35.sh создан
- [ ] AC2: scripts/tests/security/pss-restricted-41.sh создан
- [ ] AC3: scripts/tests/security/pss-baseline-35.sh создан
- [ ] AC4: scripts/tests/security/pss-baseline-41.sh создан
- [ ] AC5: scripts/tests/security/scc-restricted-35.sh создан
- [ ] AC6: scripts/tests/security/scc-restricted-41.sh создан
- [ ] AC7: scripts/tests/security/scc-anyuid-35.sh создан
- [ ] AC8: scripts/tests/security/scc-anyuid-41.sh создан
- [ ] AC9: scripts/tests/lib/security-validation.sh библиотека создана
- [ ] AC10: Все PSS тесты проверяют runAsNonRoot, seccompProfile, capabilities
- [ ] AC11: Все SCC тесты проверяют SCC assignment
- [ ] AC12: Все тесты имеют YAML frontmatter
...
Smoke tests для validation PSS compliance и OpenShift SCC assignment.
...
1. **Create scripts/tests/lib/security-validation.sh**
   ...
   Библиотека с validation функциями:
   ```bash
   #!/bin/bash
...
- 8 security smoke тестов созданы
- Библиотека security-validation.sh с reusable функциями
- Все тесты следуют существующему pattern

...
- 12 Jupyter runtime images (3.5/4.1 × variants)
...
- [x] AC1-AC6: Jupyter Dockerfile, build-3.5.sh, build-4.1.sh, port 8888, Spark Connect, GPU/Iceberg — ✅
...
| docker/runtime/jupyter/ | Dockerfile, build scripts, jupyter_startup.py | ✅ | ✅ |
| test-jupyter-runtime.sh | exists | ✅ | ✅ |
| bash -n | pass | ✅ | ✅ |

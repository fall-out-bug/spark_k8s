...
- anyuid SCC × Spark 3.5/4.1 × components (connect, history-server)
- nonroot SCC × Spark 3.5/4.1 × components (jupyter, hive-metastore)
- restricted-v2 SCC × Spark 3.5/4.1 × components
- OpenShift presets × anyuid/restricted compatibility
...
- [x] AC1: 4 test files in tests/security/scc/ — ✅
- [x] AC2: test_scc_anyuid.py validates anyuid SCC — ✅
- [x] AC3: test_scc_nonroot.py validates nonroot SCC — ✅
- [x] AC4: test_scc_restricted_v2.py validates restricted-v2 SCC — ✅
- [x] AC5: test_scc_presets.py validates OpenShift presets — ✅
- [x] AC6: All tests use mocked oc commands — ✅
- [x] AC7: Coverage >= 80% (89–100%) — ✅
...
|-------|--------|
| Completion Criteria | ✅ |
| Tests & Coverage | ✅ 89–100% |
| AI-Readiness | ✅ max 150 LOC |
| Type Hints | ✅ |
| Error Handling | ✅ |

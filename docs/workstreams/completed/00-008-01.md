...
- [x] AC1: 12+ Jupyter GPU/Iceberg scenario scripts created — ✅
- [x] AC2: YAML frontmatter (@meta) in scenarios — ✅
- [x] AC3: GPU skip logic (check_gpu_available) — ✅ (parallel.sh)
- [x] AC4: Iceberg skip logic (check_iceberg_available) — ✅ (parallel.sh)
- [x] AC5-AC6: Sequential/parallel execution — ✅ (run-smoke-tests.sh)
...
| Jupyter GPU/Iceberg scenarios | 12+ | 20+ | ✅ |
| TODO/FIXME | 0 | 0 | ✅ |

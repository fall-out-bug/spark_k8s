...
- Tests validate Spark 4.1.0, 4.1.1 × Jupyter, Airflow × connect-k8s × GPU mode
- RAPIDS acceleration verification (GPU vs CPU comparison)

**Acceptance Criteria:**
- [ ] AC1: 16 GPU E2E scenarios created (Jupyter/Airflow × 4.1.0/4.1.1 × connect-k8s × GPU)
...
- `scripts/tests/e2e/conftest.py` — Base E2E fixtures (from WS-00-012-01)
- `scripts/tests/e2e/queries/` — Standard SQL queries
- `charts/spark-4.1/` — Spark 4.1.x charts with GPU support
...
2. **Implement GPU E2E test scenarios:**
   - `test_jupyter_gpu_410.py` — Jupyter with GPU, Spark 4.1.0
   - `test_jupyter_gpu_411.py` — Jupyter with GPU, Spark 4.1.1
   - `test_airflow_gpu_410.py` — Airflow with GPU, Spark 4.1.0
   - `test_airflow_gpu_411.py` — Airflow with GPU, Spark 4.1.1
...
- All 16 scenarios (4 modules × 4 queries) pass
...
- [x] AC1-AC5: GPU E2E (test_jupyter_gpu_410/411, test_airflow_gpu_410/411), fixtures_gpu.py — ✅
...
| test_*_gpu_*.py | 4 files | ✅ | ✅ |
| fixtures_gpu.py | exists | ✅ | ✅ |

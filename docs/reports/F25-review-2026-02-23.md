...
> **Historical snapshot (2026-02-23), recovered 2026-08-09 from `main` (commit
> e662beb, previously absent from `dev`).** Reflects the Feb-2026 belief that all
> 12 F25 workstreams were complete. Note: the load-tests effort was later
> re-opened in `dev` as the aspirational `spark-load-tests-10gb` spec (0/30 tasks)
> — treat this report as point-in-time provenance, not current status.

...
```bash
# Dev (local)
helm template my-spark charts/spark-4.1 -f charts/spark-4.1/presets/dev.yaml

# Production
helm template my-spark charts/spark-4.1 -f charts/spark-4.1/presets/prod.yaml
```

## Shared Overlay

For multi-version deployment (Spark 3.5 + 4.1), see:

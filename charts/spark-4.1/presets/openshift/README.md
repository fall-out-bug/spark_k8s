# OpenShift Presets for Spark 4.1

This directory contains OpenShift-specific configuration presets for deploying Spark 4.1 on OpenShift clusters.
...
helm install my-spark charts/spark-4.1 \
  -f charts/spark-4.1/presets/openshift/restricted.yaml \
  -n spark-openshift \
  --create-namespace
```
...
```bash
helm install my-spark charts/spark-4.1 \
  -f charts/spark-4.1/presets/openshift/anyuid.yaml \
  -n spark-openshift \
  --create-namespace
```

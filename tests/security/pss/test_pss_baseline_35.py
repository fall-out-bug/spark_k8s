"""
PSS Baseline tests for Spark 3.5
...
class TestPSSBaseline35:
    """Tests for PSS baseline profile compliance on Spark 3.5"""

    def test_namespace_pss_baseline_labels(self, chart_35_path, preset_35_baseline):

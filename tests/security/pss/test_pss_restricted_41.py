"""
PSS Restricted tests for Spark 4.1
...
class TestPSSRestricted41:
    """Tests for PSS restricted profile compliance on Spark 4.1"""

    def test_namespace_pss_restricted_labels(self, chart_41_path, preset_41_baseline):
    ...
    def test_seccomp_profile_set(self, chart_41_path, preset_41_baseline):

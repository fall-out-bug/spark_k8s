...
| Result | Count | Notes |
|--------|-------|-------|
| PASS | 6 | 0069, 0070, 0071, 0072, 0075, 0076, 0079, 0080 (3.5.7 standalone) |
| SKIP | ~90 | Connect scenarios - run-matrix uses spark-standalone only |
...
- Fix: image_tag before minikube block (unbound variable)
